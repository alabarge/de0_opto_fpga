...
#define  COM_ERR_MMAP         0x80000800
#define  COM_ERR_THREAD       0x80001000
#define  COM_ERR_UIO_INT      0x80002000
#define  COM_ERR_POLL         0x80004000
...
typedef union _com_int_reg_t {
   struct {
      uint32_t tx   : 1;  // ftdi_INT(0)
      uint32_t rx   : 1;  // ftdi_INT(1)
      uint32_t pipe : 1;  // ftdi_INT(2)
      uint32_t      : 29;
   } b;
   uint32_t i;
...
typedef union _com_ctl_reg_t {
   struct {
      uint32_t tx_head        : 2;  // ftdi_CONTROL(1:0)
      uint32_t rx_tail        : 2;  // ftdi_CONTROL(3:2)
      uint32_t                : 21; // ftdi_CONTROL(24:4)
      uint32_t pipe_int       : 1;  // ftdi_CONTROL(25)
      uint32_t dma_req        : 1;  // ftdi_CONTROL(26)
      uint32_t rx_int         : 1;  // ftdi_CONTROL(27)
      uint32_t tx_int         : 1;  // ftdi_CONTROL(28)
      uint32_t pipe_run       : 1;  // ftdi_CONTROL(29)
      uint32_t ftdi_run       : 1;  // ftdi_CONTROL(30)
      uint32_t enable         : 1;  // ftdi_CONTROL(31)
   } b;
   uint32_t i;
...
typedef union _com_ctl_sta_t {
   struct {
      uint32_t tail_addr      : 16; // ftdi_STATUS(15:0)
      uint32_t rx_head        : 2;  // ftdi_STATUS(17:16)
      uint32_t tx_tail        : 2;  // ftdi_STATUS(19:18)
      uint32_t                : 9;  // ftdi_STATUS(28:20)
      uint32_t rx_rdy         : 1;  // ftdi_STATUS(29)
      uint32_t tx_rdy         : 1;  // ftdi_STATUS(30)
      uint32_t tx_busy        : 1;  // ftdi_STATUS(31)
   } b;
   uint32_t i;
