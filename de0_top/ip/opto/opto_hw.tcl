...
set_fileset_property quartus_synth TOP_LEVEL opto_top
set_fileset_property quartus_synth ENABLE_RELATIVE_INCLUDE_PATHS true
add_fileset_file opto_top.vhd VHDL PATH opto_top.vhd
add_fileset_file opto_regs.vhd VHDL PATH opto_regs.vhd
...
set_fileset_property sim_vhdl TOP_LEVEL opto_top
...
#
# connection point opto_export
#
add_interface opto_export conduit end
set_interface_property opto_export associatedClock clk
set_interface_property opto_export associatedReset reset
set_interface_property opto_export ENABLED true

add_interface_port opto_export head_addr export Input 16
add_interface_port opto_export tail_addr export Output 16

add_interface_port opto_export fsclk export Output 1
add_interface_port opto_export fscts export Input 1
